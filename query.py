...
def createQuery(dataDict):
    ...
    return string_query 
        ...
        # elif key == "F107":
        #     minRange = float(dataDict[key][0])
        #     maxRange = float(dataDict[key][1])
        #     if minRange <= maxRange: 
        #         string_query += f"F107 BETWEEN {minRange} AND {maxRange} AND"
        #     else: 
        #         # Write Error Message
        ...
        # elif key == "EFLUX":
        #     try: 
        #         minBase, minExponent = map(int, dataDict[key][0].split("^"))
        #         maxBase, maxExponent = map(int, dataDict[key][1].split("^"))

        #         minRange = pow(minBase,minExponent)
        #         maxRange = pow(maxBase,maxExponent)
                
        #         if minRange <= maxRange: 
        #             string_query += f"EFLUX BETWEEN {minRange} AND {maxRange} AND"
        #     except:
        #         # Write Error Message
        #         print("Error")
        ...
        # elif key == "NFLUX":
        #     try: 
        #         if "^" in dataDict[key][0]: 
        #             minBase, minExponent = map(int, dataDict[key][0].split("^"))
        #             minRange = pow(minBase,minExponent)
        #         else: 
        #             minRange = float(dataDict[key][0])

        #         if "^" in dataDict[key][1]: 
        #             maxBase, maxExponent = map(int, dataDict[key][1].split("^"))
        #             maxRange = pow(maxBase,maxExponent)
        #         else: 
        #             minRange = float(dataDict[key][1])
        ...
        #     minRange = float(dataDict[key][0])
        #     maxRange = float(dataDict[key][1])
        #     if minRange >= 0 and  maxRange <= 180 and minRange <= maxRange: 
        #         string_query += f"CONJUGATE_SZA BETWEEN {minRange} AND {maxRange} AND"
        #     else:
        #         # Write Error Message
        #         print("Error")
        ...
        #     minRange = float(dataDict[key][0])
        #     maxRange = float(dataDict[key][1])
        #     if minRange >= 0 and  maxRange <= 9 and minRange <= maxRange: 
        #         string_query += f"CONJUGATE_SZA BETWEEN {minRange} AND {maxRange} AND"
        #     else:
        #         # Write Error Message
        #         print("Error")
        ...
        # elif key == "MECHS":
        #     selection = dataDict[key][0]
        #     string_query += f"{selection} ... "



    # queryData(string_query)


# A function that executes the query to extract data from MySQL Database
def queryData(string_query):     
    try:
        # Connect to MySQL
        connection = mysql.connector.connect(
            host="localhost",
            user="bryanl",
            password="@m468a.space.umn.edu",
            database="DombeckDB"
        )
